...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click GroestlCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start GroestlCoin: click-to-pay handler");
    else
...
{
    // clicking on GroestlCoin: URLs creates FileOpen events on the Mac:
